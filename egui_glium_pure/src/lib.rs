...
fn redraw(egui : &mut egui_glium::EguiGlium, display: &glium::Display, control_flow: &mut ControlFlow){
...
pub fn egui_glium_pure_example() {
    ...
    event_loop.run_return(move |event, _, control_flow| {
        ...
        match event {
            ...
            glutin::event::Event::RedrawEventsCleared if cfg!(windows) => redraw(&mut egui, &display, control_flow),
            glutin::event::Event::RedrawRequested(_) if !cfg!(windows) => redraw(&mut egui, &display, control_flow),
...
pub extern fn egui_glium_pure_example_c_wrapper() {
    ...
    println!("event_loop clean finish");
}
